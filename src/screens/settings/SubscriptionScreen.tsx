...
import { daysLeftInTrial, isTrialExpired } from "@/domain/usageLimits";
        ...
        {loading ? (
          ...
          <>
            <Card style={{ marginTop: spacing.md }}>
              ...
              {info?.status === "none" && (
                <Text style={typography.bodyMuted}>
                  {trialStartedAt && !isTrialExpired(trialStartedAt)
                    ? `You're on your free trial — ${daysLeftInTrial(trialStartedAt)} day${
                        daysLeftInTrial(trialStartedAt) === 1 ? "" : "s"
                      } left.`
                    : "Your free trial has ended. Subscribe to keep using YumTrack."}
                </Text>
              )}
            </Card>
            ...
            {info?.status === "none" ? (
              ...
              <>
                ...
                <Text style={styles.helperText}>
                  Opens your device's native subscription settings — cancel anytime, no
                  need to contact us. Cancelling stops future renewals; you keep access
                  until the period you already paid for ends.
                </Text>
              </>
            )}
